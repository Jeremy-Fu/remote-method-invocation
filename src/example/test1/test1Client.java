 ...
 * are both non-remote serializable object. It looks up the stub of a person
 * object named 'PersonOnServerRegistry', sets the name of the remote object
 * to the String parameter passed in and finally gets the name of the remote
 * object again after the name is set. Both of the setter and getter method of
 * the instance variable NAME are remote method invocations
 * 
 */
